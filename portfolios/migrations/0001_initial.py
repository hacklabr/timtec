...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'portfolios_portfolio', (
            ...
            ('url_doc', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('data', self.gf('django.db.models.fields.TextField')()),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='portfolios', null=True, to=orm['core.Unit'])),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'portfolios', ['Portfolio'])

        # Adding model 'PortfolioItem'
        db.create_table(u'portfolios_portfolioitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'portfolios', ['PortfolioItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'portfolios_portfolioitem')
    ...
    models = {
        ...
        u'portfolios.portfolioitem': {
            'Meta': {'ordering': "['timestamp']", 'object_name': 'PortfolioItem'},
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'data': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
