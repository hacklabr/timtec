...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.hidden_by'
        db.add_column(u'forum_question', 'hidden_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='hidden_questions', null=True, blank=True, to=orm['accounts.TimtecUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.hidden_by'
        db.delete_column(u'forum_question', 'hidden_by_id')
    ...
    models = {
        ...
        u'forum.question': {
            ...
            'hidden_by': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'hidden_questions'", 'null': 'True', 'blank': 'True', 'to': u"orm['accounts.TimtecUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_questions'", 'to': u"orm['accounts.TimtecUser']"})
        },
