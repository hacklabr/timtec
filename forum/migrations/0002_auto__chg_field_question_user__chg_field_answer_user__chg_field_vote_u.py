...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Question.user'
        db.alter_column(u'forum_question', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimtecUser']))

        # Changing field 'Answer.user'
        db.alter_column(u'forum_answer', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimtecUser']))

        # Changing field 'Vote.user'
        db.alter_column(u'forum_vote', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimtecUser']))
