...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.hidden_justification'
        db.add_column(u'forum_question', 'hidden_justification',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.hidden_justification'
        db.delete_column(u'forum_question', 'hidden_justification')
