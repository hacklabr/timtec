...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            db.alter_column(u'core_class_students', 'timtecuser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ifs.IfUser']))
            db.rename_column(u'core_class_students', 'timtecuser_id', 'ifuser_id')
        except:
            pass

        try:
            db.alter_column(u'core_professormessage_users', 'timtecuser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ifs.IfUser']))
            db.rename_column(u'core_professormessage_users', 'timtecuser_id', 'ifuser_id')
        except:
            pass
