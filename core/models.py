...
class ProfessorMessage(models.Model):
    ...
    users_that_read = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='read_messages', blank=True)
    ...
    def send(self):
        ...
        email = EmailMessage(subject, message, settings.DEFAULT_FROM_EMAIL, [settings.DEFAULT_FROM_EMAIL, ], bcc)
