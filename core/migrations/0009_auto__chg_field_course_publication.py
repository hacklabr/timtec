...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.publication'
        db.alter_column(u'core_course', 'publication', self.gf('django.db.models.fields.DateField')(default=None))
    ...
    models = {
        ...
        u'core.course': {
            ...
            'publication': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True'}),
