...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseAuthor.position'
        # db.add_column(u'core_courseauthor', 'position',
        #               self.gf('django.db.models.fields.IntegerField')(default=100, null=True, blank=True),
        #               keep_default=False)

        # Adding field 'Course.min_percent_to_complete'
        db.add_column(u'core_course', 'min_percent_to_complete',
                      self.gf('django.db.models.fields.IntegerField')(default=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseAuthor.position'
        # db.delete_column(u'core_courseauthor', 'position')

        # Deleting field 'Course.min_percent_to_complete'
        db.delete_column(u'core_course', 'min_percent_to_complete')
