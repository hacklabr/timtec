...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_lesson', 'status',
                      self.gf('django.db.models.fields.CharField')(default='draft', max_length=64),
                      keep_default=False)


        # Changing field 'Course.status'
        db.alter_column(u'core_course', 'status', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):
        # Deleting field 'Lesson.status'
        db.delete_column(u'core_lesson', 'status')


        # Changing field 'Course.status'
        db.alter_column(u'core_course', 'status', self.gf('django.db.models.fields.CharField')(max_length=128))
