...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_lesson', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=255, populate_from='name', unique_with=()))
        # Adding field 'Course.home_thumbnail'
        db.add_column(u'core_course', 'home_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.home_position'
        db.add_column(u'core_course', 'home_position',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.start_date'
        db.add_column(u'core_course', 'start_date',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Lesson.slug'
        db.alter_column(u'core_lesson', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True))
        # Deleting field 'Course.home_thumbnail'
        db.delete_column(u'core_course', 'home_thumbnail')

        # Deleting field 'Course.home_position'
        db.delete_column(u'core_course', 'home_position')

        # Deleting field 'Course.start_date'
        db.delete_column(u'core_course', 'start_date')
    ...
    models = {
        ...
        u'core.course': {
            ...
            'home_position': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
