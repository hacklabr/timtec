...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseProfessor.picture'
        db.add_column(u'core_courseprofessor', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseProfessor.name'
        db.add_column(u'core_courseprofessor', 'name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_courseprofessor', 'picture')
