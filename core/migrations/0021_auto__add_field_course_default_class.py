...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.default_class'
        db.add_column(u'core_course', 'default_class',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='default_course', unique=True, null=True, to=orm['core.Class']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.default_class'
        db.delete_column(u'core_course', 'default_class_id')
    ...
    models = {
        ...
        u'core.course': {
            ...
            'default_class': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'default_course'", 'unique': 'True', 'null': 'True', 'to': u"orm['core.Class']"}),
