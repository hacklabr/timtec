...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.home_published'
        db.add_column(u'core_course', 'home_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.home_published'
        db.delete_column(u'core_course', 'home_published')
