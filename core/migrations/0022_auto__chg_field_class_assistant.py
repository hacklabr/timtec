...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Class.assistant'
        raise RuntimeError("Cannot reverse this migration. 'Class.assistant' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Class.assistant'
        db.alter_column(u'core_class', 'assistant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.TimtecUser']))
