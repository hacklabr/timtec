...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lesson.desc'
        db.alter_column(u'core_lesson', 'desc', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Lesson.desc'
        db.alter_column(u'core_lesson', 'desc', self.gf('django.db.models.fields.CharField')(max_length=255))
