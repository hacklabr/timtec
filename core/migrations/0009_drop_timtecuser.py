...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_answer', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.TimtecUser']))
    ...
    def backwards(self, orm):
        # Changing field 'CourseProfessor.user'
        db.alter_column(u'core_courseprofessor', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimtecUser']))

        # Changing field 'Answer.user'
        db.alter_column(u'core_answer', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimtecUser']))

        # Changing field 'CourseStudent.user'
        db.alter_column(u'core_coursestudent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimtecUser']))

        # Changing field 'StudentProgress.user'
        db.alter_column(u'core_studentprogress', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimtecUser']))
