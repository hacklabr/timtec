...
class Migration(SchemaMigration):
    depends_on = (
        ('activities', '0002_create_activity_and_answer'),
    )

    def forwards(self, orm):
        # Changing field 'Unit.activity'
        db.alter_column(u'core_unit', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Activity'], null=True))

    def backwards(self, orm):
        # Adding model 'Answer'
        db.alter_column(u'core_unit', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Activity'], null=True))
