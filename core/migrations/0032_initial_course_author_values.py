        ...
        for course_professor in orm.CourseProfessor.objects.all():
            if course_professor.role == 'instructor':
                ...
                orm.CourseAuthor.objects.create(
                    ...
                    biography=course_professor.biography,
                    picture=course_professor.picture,
                    name=course_professor.name
                )
                course_professor.delete()

    def backwards(self, orm):
        for course_author in orm.CourseAuthor.objects.all():
            course_author.delete()
