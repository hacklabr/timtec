...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseCertification'
        db.create_table(u'core_coursecertification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('course_student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CourseStudent'], unique=True)),
            ...
            ('course_workload', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('course_total_units', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'core', ['CourseCertification'])


    def backwards(self, orm):
        # Deleting model 'CourseCertification'
        db.delete_table(u'core_coursecertification')
