...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CertificationProcess'
        db.create_table(u'core_certificationprocess', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_certification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CourseCertification'])),
            ('comments', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('evaluation_grade', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('no_show', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('evaluation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Evaluation'])),
        ))
        db.send_create_signal(u'core', ['CertificationProcess'])

        # Adding model 'Evaluation'
        db.create_table(u'core_evaluation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('min_grade', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('results_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('instructions', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('klass', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Class'])),
        ))
        db.send_create_signal(u'core', ['Evaluation'])

        # Deleting field 'CourseCertification.link'
        db.delete_column(u'core_coursecertification', 'link')

        # Adding field 'CourseCertification.link_hash'
        db.add_column(u'core_coursecertification', 'link_hash',
                      self.gf('django.db.models.fields.CharField')(default='nolink', max_length=255),
                      keep_default=False)


        # Changing field 'CourseCertification.modified_date'
        db.alter_column(u'core_coursecertification', 'modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'CourseCertification.created_date'
        db.alter_column(u'core_coursecertification', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'CertificationProcess'
        db.delete_table(u'core_certificationprocess')

        # Deleting model 'Evaluation'
        db.delete_table(u'core_evaluation')

        # Adding field 'CourseCertification.link'
        db.add_column(u'core_coursecertification', 'link',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Deleting field 'CourseCertification.link_hash'
        db.delete_column(u'core_coursecertification', 'link_hash')


        # Changing field 'CourseCertification.modified_date'
        db.alter_column(u'core_coursecertification', 'modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'CourseCertification.created_date'
        db.alter_column(u'core_coursecertification', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'core.certificationprocess': {
            'Meta': {'object_name': 'CertificationProcess'},
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'comments': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'course_certification': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.CourseCertification']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'evaluation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Evaluation']"}),
            'evaluation_grade': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'no_show': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'core.class': {
        ...
        u'core.course': {
            ...
            'min_percent_to_complete': ('django.db.models.fields.IntegerField', [], {'default': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'core.coursecertification': {
            'Meta': {'object_name': 'CourseCertification'},
            'course_student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.CourseStudent']", 'unique': 'True'}),
            'course_total_units': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'course_workload': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'link_hash': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'core.evaluation': {
            ...
            'klass': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Class']"}),
            'min_grade': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'results_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'})
        },
        u'core.lesson': {
