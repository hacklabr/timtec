...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfessorMessage.course'
        db.add_column(u'core_professormessage', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Course'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfessorMessage.course'
        db.delete_column(u'core_professormessage', 'course_id')
