...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_professormessage', (
            ...
            ('professor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CourseProfessor'])),
        ...
        db.create_table(m2m_table_name, (
            ...
            ('coursestudent', models.ForeignKey(orm[u'core.coursestudent'], null=False))
        ))
        db.create_unique(m2m_table_name, ['professormessage_id', 'coursestudent_id'])
