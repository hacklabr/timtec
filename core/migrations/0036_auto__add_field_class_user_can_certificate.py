...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Class.user_can_certificate'
        db.add_column(u'core_class', 'user_can_certificate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Class.user_can_certificate'
        db.delete_column(u'core_class', 'user_can_certificate')
    ...
    models = {
        ...
        u'core.class': {
            ...
            'user_can_certificate': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'core.course': {
