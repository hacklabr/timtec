...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.unit'
        db.add_column(u'activities_activity', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activities', null=True, to=orm['core.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.unit'
        db.delete_column(u'activities_activity', 'unit_id')
