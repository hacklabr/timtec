...
SITE_ID = 1
SITE_HOME = env('DJANGO_SITE_HOME', default='')
...
ADMINS = (
    (env('DJANGO_ADMIN_NAME', default='admin'), env('DJANGO_ADMIN_EMAIL', default='root@localhost')),
)
...
DEFAULT_FROM_EMAIL = env('DJANGO_EMAIL_HOST', default='root@localhost')
...
METRON_SETTINGS = {
    "google": {
        1: env("GOOGLE_ANALYTICS_KEY", default="set-your-google-analytics-key-here")
    },
}
...
TIME_ZONE = env('DJANGO_TIMEZONE', default='America/Sao_Paulo')
...
MEDIA_ROOT = "/app/webfiles/media/"
STATIC_ROOT = "/app/webfiles/static/"
