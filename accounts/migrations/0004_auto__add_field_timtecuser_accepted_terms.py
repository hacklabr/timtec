...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimtecUser.accepted_terms'
        db.add_column(u'accounts_timtecuser', 'accepted_terms',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimtecUser.accepted_terms'
        db.delete_column(u'accounts_timtecuser', 'accepted_terms')
